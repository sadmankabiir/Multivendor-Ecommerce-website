...
function EditCoupon() {
    ...
    const fetchData = async () => {
        try {
            await axios.get(`vendor-coupon-detail/${UserData().vendor_id}/${param.coupon_id}/`).then((res) => {
                setCoupon(res.data);
            })
        } catch (error) {
    ...
    const handleUpdateCoupon = async (e) => {
        ...
        await axios.patch(`vendor-coupon-detail/${UserData().vendor_id}/${param.coupon_id}/`, formdata).then((res) => {
            setCoupon(res.data);
            Swal.fire({
                icon: 'success',
